...
class PpuMemory
{
    static func KB(_ n:UInt)->UInt16
    {
    ...
    static let kPpuMemorySize:UInt16                = KB(16)

        // CHR-ROM stores pattern tables
    static let kChrRomBase:UInt16                = 0x0000
    static let kChrRomSize:UInt16                = KB(8) // Half the memory is CHR-ROM (2 pattern tables of 4kb each)
    static let kChrRomEnd:UInt16                    = kChrRomBase + kChrRomSize

        // VRAM (aka CIRAM) stores name tables
    static let kVRamBase:UInt16                    = 0x2000
    static let kVRamSize:UInt16                    = KB(4)
    static let kVRamEnd:UInt16                    = UInt16(kVRamBase + KB(8) - 256) // Mirrored
