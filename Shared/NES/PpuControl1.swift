...
class PpuStatus
{
    static let VRAMWritesIgnored:UInt8     = 0b00010000//BIT(4)
    static let SpriteOverflow:UInt8        = 0b00100000//BIT(5)
    static let PpuHitSprite0:UInt8         = 0b01000000//BIT(6)
    static let InVBlank:UInt8              = 0b10000000//BIT(7)
}
